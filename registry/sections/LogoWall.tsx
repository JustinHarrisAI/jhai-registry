 ...
 *
 * It belongs immediately under the hero, before any argument: recognisable client marks are
 * the fastest proof a page has, and they stop working the moment a visitor has to scroll for
 * them. Grayscale at 60% so the strip reads as evidence rather than decoration, and the row is
 * duplicated once so the marquee loop has no seam.
 */
