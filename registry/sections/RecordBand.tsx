/**
 * The record: four figures, hairline-divided, on the same paper ground as the logo wall
 * above it so the fold reads as one block of evidence rather than two sections.
 *
 * The export counts these up from zero on scroll. That is a script behaviour and the end
 * state is the number, so the number is what renders.
 */
